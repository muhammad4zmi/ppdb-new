...
<head>
    ...
    <!--style bootstrap-->
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url(); ?>/assets/img/mumin.png" />
...
<body cz-shortcut-listen="true">
    <div style="margin:0 auto;width:800px;">
        ...
        <table align="center" width="800" border="0" cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                    <td><img src="<?= base_url(); ?>/assets/img/mumin.png" width="100"></td>
        ...
        <table width="800" align="center" border="0" cellpadding="0" cellspacing="0" class="krs_box">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tl">PROGRAM PILIHAN 1<br><em> </em></td>
