                            ...
                            <?php foreach ($submenu as $sm) : ?>
                                <tr style="font-size: 12px;">
                                    ...
                                    <td align="center">
                                        ...
                                        <!--</form>-->
                                        <a href="/menu/delete_submenu/<?= $sm['id']; ?>" class="btn btn-danger m-1 btn-circle tombol-hapus btn-sm" data-placement="top" title="" data-toggle="tooltip" data-original-title="Ubah Informasi <?= $k['keterangan']; ?>">
